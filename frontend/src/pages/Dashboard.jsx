  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
        <StatCard icon={<FileText className="w-5 h-5" />} label={t('dashboard.total')} value={total} color="bg-indigo-50 text-indigo-600" />
        <StatCard icon={<AlertCircle className="w-5 h-5" />} label={t('dashboard.open')} value={offen} color="bg-red-50 text-red-600" />
        <StatCard icon={<Receipt className="w-5 h-5" />} label={t('dashboard.invoices')} value={rechnungen} color="bg-amber-50 text-amber-600" />
        <StatCard icon={<Mail className="w-5 h-5" />} label={t('dashboard.letters')} value={briefe} color="bg-blue-50 text-blue-600" />
      </div>
...
function StatCard({ icon, label, value, color }) {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-3 md:p-4" style={{ minHeight: '44px' }}>
