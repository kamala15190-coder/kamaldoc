  ...
  const icon = entry.status === 'done'
    ...
    : entry.status === 'error'
      ...
      : entry.status === 'uploading'
        ? <div style={{ width: 16, height: 16, borderRadius: '50%', border: '2px solid rgba(232,154,82,0.25)', borderTopColor: 'var(--accent-solid)', animation: 'spin 0.8s linear infinite', flexShrink: 0 }} />
        ...
        <div className="glass-card animate-scale-in" style={{ padding: 20, border: '1px solid rgba(16,185,129,0.25)' }}>
          ...
          {uploading && (
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, padding: '12px 0' }}>
              <div style={{ width: 20, height: 20, borderRadius: '50%', border: '2px solid rgba(232,154,82,0.2)', borderTopColor: 'var(--accent-solid)', animation: 'spin 0.8s linear infinite' }} />
