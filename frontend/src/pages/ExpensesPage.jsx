...
const CATEGORY_COLORS = {
  Lebensmittel: '#ef4444', Telekommunikation: '#B66B2C', Versicherung: '#E89A52',
  ...
  if (subLoading) {
    return (
      <div style={{ display: 'flex', justifyContent: 'center', padding: '60px 0' }}>
        <div style={{ width: 36, height: 36, borderRadius: '50%', border: '3px solid rgba(232,154,82,0.15)', borderTopColor: 'var(--accent-solid)', animation: 'spin 0.8s linear infinite' }} />
                ...
                <ResponsiveContainer>
                  <BarChart data={chartData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
                    ...
                    <Tooltip
                      ...
                      itemStyle={{ color: '#F6C58A' }}
                    />
                    <Bar dataKey="value" radius={[4, 4, 0, 0]} fill="#B66B2C" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </div>
