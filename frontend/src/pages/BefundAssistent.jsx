      ...
      <div className="glass-card animate-fade-in-up" style={{ overflow: 'hidden', padding: 0 }}>
        ...
        {loading ? (
          <div style={{ display: 'flex', justifyContent: 'center', padding: '40px 0' }}>
            <div style={{ width: 28, height: 28, borderRadius: '50%', border: '3px solid rgba(232,154,82,0.15)', borderTopColor: 'var(--accent-solid)', animation: 'spin 0.8s linear infinite' }} />
          </div>
        ) : docs.length === 0 ? (
