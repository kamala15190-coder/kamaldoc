    ...
    return (
      <div style={{ display: 'flex', justifyContent: 'center', padding: '60px 0' }}>
        <div style={{
          ...
          border: '3px solid rgba(232,154,82,0.15)',
...
function ReminderSettings({ docId, currentDays, onUpdate }) {
  ...
  return (
    <div style={{ marginTop: 10, paddingTop: 10, borderTop: '1px solid var(--border-glass)' }}>
      ...
      {saving && <div style={{ width: 16, height: 16, borderRadius: '50%', border: '2px solid rgba(232,154,82,0.2)', borderTopColor: 'var(--accent-solid)', animation: 'spin 0.8s linear infinite', marginTop: 8 }} />}
    </div>
  );
}
