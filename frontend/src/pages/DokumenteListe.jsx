          ...
          <div className="hide-scrollbar" style={{ display: 'flex', gap: 6, overflowX: 'auto', paddingBottom: 6 }}>
            {[
              ...
              <button key={opt.value} onClick={() => setFilter(opt.value)} style={{
                ...
                background: filter === opt.value ? 'rgba(232,154,82,0.12)' : 'transparent',
                color: filter === opt.value ? '#E89A52' : tc.textMuted,
                borderColor: filter === opt.value ? 'rgba(232,154,82,0.3)' : tc.border,
              }}>{opt.label}</button>
            ))}
          </div>
        )}
          ...
          {showEmails && (emailLoading || emailResults.length > 0) && (
            <>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8, paddingLeft: 2 }}>
                ...
                {emailLoading && <Loader2 style={{ width: 12, height: 12, color: '#E89A52', animation: 'spin 0.8s linear infinite' }} />}
              </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{
                          ...
                          background: providerInfo.color ? `${providerInfo.color}18` : 'rgba(232,154,82,0.12)',
                          display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
                        }}>
                          <Mail style={{ width: 16, height: 16, color: providerInfo.color || '#E89A52' }} />
                        </div>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 2 }}>
                            <span style={{
                              ...
                              background: providerInfo.color ? `${providerInfo.color}18` : 'rgba(232,154,82,0.12)',
                              color: providerInfo.color || '#E89A52',
                            }}>
